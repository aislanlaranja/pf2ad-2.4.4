...
if [ "$(cat /etc/version)" != "2.4.4-RELEASE-p1" ]; then
...
fetch -o /usr/local/pkg -q https://raw.githubusercontent.com/aislanlaranja/pf2ad-2.4.4/master/samba.inc
fetch -o /usr/local/pkg -q https://raw.githubusercontent.com/aislanlaranja/pf2ad-2.4.4/master/samba.xml
...
cd /usr/local/pkg
fetch -o - -q https://raw.githubusercontent.com/aislanlaranja/pf2ad-2.4.4/master/squid_winbind_auth.patch | patch -b -p0 -f
fetch -o /usr/local/pkg -q https://raw.githubusercontent.com/aislanlaranja/pf2ad-2.4.4/master/squid.inc
